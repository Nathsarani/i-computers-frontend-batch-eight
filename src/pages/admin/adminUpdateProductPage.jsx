    ...
    return(
        <div className="w-full flex justify-center p-[50px] ">
            ...
            <div className="w-[800px] bg-accent/95 rounded-4xl p-[40px]">
                ...
                <h1 className="w-full text-xl text-primary mb-[20px] flex items-center gap-[5px]"> <AiFillProduct />Update Product</h1>
                    ...
                    <div className="w-full bg-white p-[20px] flex flex-row flex-wrap justify-between rounded-xl shadow-2xl " >
                       ...
                       <div className="my-[10px] w-[40%]">    
                            ...
                            <input 
                            disabled 
                            type ="text" value= {productID} onChange={(e)=>{setProductID(e.target.value)}} className="w-full h-[40px] rounded-2xl border-accent border-2 focus:outline-none focus:ring-2 focus:ring-accent px-[20px] "></input>
